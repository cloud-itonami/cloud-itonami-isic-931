# Operator Quickstart — cloud-itonami-isic-931

Shortest path from clone to a verified local dry-run for **ISIC 931** (`cloud-itonami-isic-931`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-931.git
cd cloud-itonami-isic-931
```
...
- Likely source path: `sportsleagueadminops.governor.cljc`
